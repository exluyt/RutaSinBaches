...
public class _07_PaginaPrincipalAdmin extends JFrame implements Vista {
	...
	new String[] {
		...
		table4.getColumnModel().getColumn(0).setMinWidth(75);
		table4.getColumnModel().getColumn(0).setMaxWidth(75);
		table4.getColumnModel().getColumn(1).setPreferredWidth(100);
		table4.getColumnModel().getColumn(1).setMinWidth(100);
		table4.getColumnModel().getColumn(1).setMaxWidth(100);
		table4.getColumnModel().getColumn(2).setPreferredWidth(150);
		table4.getColumnModel().getColumn(2).setMinWidth(150);
		table4.getColumnModel().getColumn(2).setMaxWidth(150);
		table4.getColumnModel().getColumn(3).setPreferredWidth(125);
		table4.getColumnModel().getColumn(3).setMinWidth(125);
		table4.getColumnModel().getColumn(3).setMaxWidth(125);
		table4.getColumnModel().getColumn(4).setPreferredWidth(101);
		table4.getColumnModel().getColumn(6).setPreferredWidth(25);
		table4.getColumnModel().getColumn(6).setMinWidth(25);
		table4.getColumnModel().getColumn(6).setMaxWidth(25);
